...
func TestSimAppExportAndBlockedAddrs(t *testing.T) {
	...
	db := dbm.NewMemDB()
	app := NewPassage3dApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, DefaultNodeHome, 0, encCfg, EmptyAppOptions{})
	...
	app2 := NewPassage3dApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, DefaultNodeHome, 0, encCfg, EmptyAppOptions{})
...
func TestRunMigrations(t *testing.T) {
	...
	app := NewPassage3dApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, 0, encCfg, EmptyAppOptions{})
